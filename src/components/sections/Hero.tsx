  ...
  return (
    <section id="hero" className="hero-bg text-white py-20 md:py-32" data-ai-hint="texas ranch aerial">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-secondary-foreground max-w-3xl mx-auto mb-8">
        ...
        <div className="mt-12 flex flex-wrap justify-center items-center gap-6 md:gap-10 text-secondary-foreground">
